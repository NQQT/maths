...
describe('number bonds — Year 1 (part-part-whole to 10)', () => {
    it('matches the exact sheet (no zero parts)', () => {
        ...
        expect(s).toEqual([
            ...
            {"prompt":"__ and 1 make 10","answer":"9","id":2,"type":"bonds"},
            {"prompt":"__ + 2 = 10","answer":"8","id":3,"type":"bonds"},
            ...
            {"prompt":"__ + 7 = 10","answer":"3","id":7,"type":"bonds"},
            {"prompt":"6 + __ = 10","answer":"4","id":8,"type":"bonds"},
            {"prompt":"__ + 4 = 10","answer":"6","id":9,"type":"bonds"},
            {"prompt":"1 + __ = 10","answer":"9","id":10,"type":"bonds"},
            {"prompt":"__ + 3 = 10","answer":"7","id":11,"type":"bonds"},
            {"prompt":"3 + __ = 10","answer":"7","id":12,"type":"bonds"},
            {"prompt":"__ and 7 make 10","answer":"3","id":13,"type":"bonds"},
            {"prompt":"2 + __ = 10","answer":"8","id":14,"type":"bonds"},
            {"prompt":"__ + 8 = 10","answer":"2","id":15,"type":"bonds"},
            {"prompt":"5 + __ = 10","answer":"5","id":16,"type":"bonds"},
            {"prompt":"7 + __ = 10","answer":"3","id":17,"type":"bonds"},
            {"prompt":"__ and 8 make 10","answer":"2","id":18,"type":"bonds"},
            {"prompt":"__ + 6 = 10","answer":"4","id":19,"type":"bonds"},
            {"prompt":"__ and 2 make 10","answer":"8","id":20,"type":"bonds"},
            {"prompt":"__ and 9 make 10","answer":"1","id":21,"type":"bonds"},
            {"prompt":"__ and 4 make 10","answer":"6","id":22,"type":"bonds"},
            {"prompt":"__ and 6 make 10","answer":"4","id":23,"type":"bonds"},
            {"prompt":"8 + __ = 10","answer":"2","id":24,"type":"bonds"},
        ]);
...
describe('number bonds — Year 2 (10 & 20)', () => {
    it('matches the exact sheet', () => {
        const s = sheet(g2);
        expect(s).toEqual([
            {"prompt":"__ and 4 make 20","answer":"16","id":1,"type":"bonds"},
            {"prompt":"13 + __ = 20","answer":"7","id":2,"type":"bonds"},
            {"prompt":"__ and 2 make 20","answer":"18","id":3,"type":"bonds"},
            {"prompt":"__ + 13 = 20","answer":"7","id":4,"type":"bonds"},
            {"prompt":"19 + __ = 20","answer":"1","id":5,"type":"bonds"},
            {"prompt":"__ and 13 make 20","answer":"7","id":6,"type":"bonds"},
            {"prompt":"__ and 3 make 10","answer":"7","id":7,"type":"bonds"},
            {"prompt":"__ + 8 = 10","answer":"2","id":8,"type":"bonds"},
            {"prompt":"__ + 7 = 10","answer":"3","id":9,"type":"bonds"},
            {"prompt":"__ + 1 = 20","answer":"19","id":10,"type":"bonds"},
            {"prompt":"__ + 9 = 10","answer":"1","id":11,"type":"bonds"},
            {"prompt":"6 + __ = 10","answer":"4","id":12,"type":"bonds"},
            {"prompt":"__ + 4 = 10","answer":"6","id":13,"type":"bonds"},
            {"prompt":"3 + __ = 20","answer":"17","id":14,"type":"bonds"},
            {"prompt":"__ and 8 make 20","answer":"12","id":15,"type":"bonds"},
            {"prompt":"__ + 1 = 10","answer":"9","id":16,"type":"bonds"},
            {"prompt":"__ + 5 = 10","answer":"5","id":17,"type":"bonds"},
            {"prompt":"__ + 18 = 20","answer":"2","id":18,"type":"bonds"},
            {"prompt":"__ + 14 = 20","answer":"6","id":19,"type":"bonds"},
            {"prompt":"1 + __ = 10","answer":"9","id":20,"type":"bonds"},
            {"prompt":"3 + __ = 10","answer":"7","id":21,"type":"bonds"},
            {"prompt":"__ + 3 = 10","answer":"7","id":22,"type":"bonds"},
            {"prompt":"__ + 11 = 20","answer":"9","id":23,"type":"bonds"},
            {"prompt":"__ and 7 make 20","answer":"13","id":24,"type":"bonds"},
        ]);
