...
export type PageStackProps = {
    ...
    zoom: ZoomMode;
    // Prose-style sheets print one question per row (word problems etc.).
    single?: boolean;
...
export function PageStack({ title, subtitle, pages, zoom, single, testId, pageTestId }: PageStackProps) {
